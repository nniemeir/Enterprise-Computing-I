...
* Select **IPv4 Settings**, Set method to manual, select add, set the address to 172.16.16.2, the Netmask to 255.255.255.0, and the gateway to 172.16.16.1. Set the DNS servers to 1.1.1.1. Set the Host Name to station.universalnoodles.lan. Toggle the interface. Click done
